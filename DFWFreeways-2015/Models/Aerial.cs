    ...
    public partial class AerialGalleryList
    {
        ...
        public static string[] Descriptions(string page)
        {
            ...
            switch (page)
            {
                ...
                case "sh183_diamond": info = new string[] { "Archive: SH 183 at the Texas Stadium site", "All Photos for Historical Reference", "SH 183 Dallas", "Sept 15, 2022 (update for Irving Interchange project)", "Texas Stadium" }; break;
                case "sh114_diamond": info = new string[] { "Archive: SH 114 at the Texas Stadium site", "All Photos for Historical Reference", "SH 114", "Sept 15, 2022 (update for Irving Interchange project)","Texas Stadium" }; break;
                ...
                case "i30_landry_sh360": info = new string[] { "I-30 at SH 360", "Includes archive photos of the original freeway intersection", "I-30 Landry Highway", "June 1, 2015","Six Flags Over Texas" }; break;
        ...
        public static string PageText(string page)
        {
            ...
            switch (page)
            {
                ...
                case "i635_garland": text = "Interstate 635 was rebuilt and expanded for the LBJ East Project, completed in 2024. This modernized freeway has frontage roads and tolled express lanes in the center of the freeway."; break;
                ...
                case "sh170_frontage": text = "The SH 170 frontage roads opened in 1992. The main lanes were originally planned to be tolled, but funding became available to build toll-free main lanes, with construction underway in 2021 and completion in 2023."; break;

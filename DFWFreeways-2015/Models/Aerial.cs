    ...
    public partial class AerialGalleryList
    {
        ...
        public static string[] Descriptions(string page)
        {
            ...
            switch (page)
            {
                ...
                case "i30_landry_sh360": info = new string[] { "I-30 at SH 360", "Includes archive photos of the original freeway intersection", "I-30 Landry Highway", "Sept 23, 2022","Six Flags Over Texas" }; break;
        ...
        public static string PageText(string page)
        {
            ...
            switch (page)
            {
                ...
                case "i30_landry_sh360": text = "Most of these photos are now obsolete due to construction of the 4-level interchange at SH 360, which was underway in 2016 and continues in progress in 2022."; break;
